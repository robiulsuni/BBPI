...
import '../constants/exit_popup.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Image.asset('assets/images/bbpi_logo.png'),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                            height: 100.0,
                            width: 200.0,
                            child: Image.asset('assets/images/_.png')),
                      ],
                    ),
                    Row(
